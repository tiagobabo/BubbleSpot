...
class FilmeTest < ActiveSupport::TestCase
	...
	test "filme_valido" do
		...
		:shopping_id => shoppings(:one).id, :detalhes => "Teste", :imagem => "bla.png", :trailer => "http://www.youtube.com/watch?v=SAIEamakLoY")
		assert filme.valid?
		assert filme.save
	end
	...
	test "filme_invalido_detalhes" do
		filme = Filme.new(:nome => "Teste", :sala => 1, :horarios => "Teste", 
		:shopping_id => shoppings(:one).id, :imagem => "bla.png", :trailer => "http://www.youtube.com/watch?v=SAIEamakLoY")
		assert filme.invalid?
		assert !filme.save
	end
	...
	test "filme_invalido_imagem" do
		filme = Filme.new(:nome => "Teste", :sala => 1, :horarios => "Teste", 
		:shopping_id => shoppings(:one).id, :detalhes => "Teste", :trailer => "http://www.youtube.com/watch?v=SAIEamakLoY")
		assert filme.invalid?
		assert !filme.save
	end
	...
	test "imagem_invalida" do
		filme = Filme.new(:nome => "Teste", :sala => 1, :horarios => "Teste", 
		:shopping_id => shoppings(:one).id, :detalhes => "Teste", :imagem => "bla.pdf", :trailer => "http://www.youtube.com/watch?v=SAIEamakLoY")
		assert filme.invalid?
		assert !filme.save
	end
	...
	test "trailer_invalido" do
		filme = Filme.new(:nome => "Teste", :sala => 1, :horarios => "Teste", 
		:shopping_id => shoppings(:one).id, :detalhes => "Teste", :imagem => "bla.png", :trailer => "http://google.com")
		assert filme.invalid?
		assert !filme.save
	end
